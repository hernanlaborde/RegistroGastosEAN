...
namespace RegistroGastosEAN.Controllers
{
    public class ResponsableController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,NumeroIdentificacion,Nombre,Apellido")] Responsable responsable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NumeroIdentificacion,Nombre,Apellido")] Responsable responsable)
        {
            if (ModelState.IsValid)
            {
